...
public class EnderecoCliente {
    ...
    private TipoEndereco tipo; // FATURAMENTO | ENTREGA

    // padrao só faz sentido para ENTREGA
    private boolean padrao;

    // CEP somente dígitos (8). Deixe length=8 se recriar schema; se já existir com 9, pode manter.
    @Column(nullable=false, length=8)
    private String cep;

    // Campos oriundos do ViaCEP — podem ser nulos se a API não retornar
