...
public class Cliente {
    ...
    public void addEndereco(EnderecoCliente e) {
        if (e == null) return;
    ...
    public void removeEndereco(EnderecoCliente e) {
        if (e == null) return;
        enderecos.remove(e);
    ...
    public void setEnderecos(List<EnderecoCliente> list) {
        this.enderecos = (list == null ? new ArrayList<>() : list);
    }
