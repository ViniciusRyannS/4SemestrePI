...
public class FreteService {
    ...
    /** Valida CEP (8 dígitos). Retorna apenas os dígitos. */
    ...
    /**
     * Calcula opções didáticas: valor base + pequena variação usando o último dígito do CEP.
     * Mantém compatibilidade com o front (POST /api/frete/opcoes?cep=...).
     */
